<?php
/* Smarty version 3.1.44, created on 2022-05-14 19:56:02
  from '/var/www/sappho.io/bans/themes/creatorsDARK/page_comms.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.44',
  'unifunc' => 'content_62804192378863_64592706',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e2aabe0a691bf3adbdd04e244fd224fb47ad80ca' => 
    array (
      0 => '/var/www/sappho.io/bans/themes/creatorsDARK/page_comms.tpl',
      1 => 1634755132,
      2 => 'file',
    ),
  ),
...
function content_62804192378863_64592706 (Smarty_Internal_Template $_smarty_tpl) {
...
Comment</div></td>
        ...
        <tr>
            <td><div align="left">
                    <textarea rows="10" cols="60" class="submit-fields" style="width:500px;" id="commenttext" name="commenttext"><?php echo $_smarty_tpl->tpl_vars['commenttext']->value;?>
</textarea>
                </div>
...
&nbsp;
        ...
        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['othercomments']->value), 'com');
                ...
                >
                    ...
                    <td height="16" class="listtable_1">
                        <div style="float:left;">
                            ...
                            <?php } else { ?>
                                <?php echo stripslashes(htmlspecialchars($_smarty_tpl->tpl_vars['ban']->value['player'], ENT_QUOTES, 'ISO-8859-1', true));?>

                            <?php }?>
                        </div>
                        <div style="float:right;">
                            <?php if ($_smarty_tpl->tpl_vars['view_comments']->value && $_smarty_tpl->tpl_vars['ban']->value['commentdata'] != "None" && count($_smarty_tpl->tpl_vars['ban']->value['commentdata']) > 0) {?>
                                <?php echo count($_smarty_tpl->tpl_vars['ban']->value['commentdata']);?>
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['hideadminname']->value) {?>
                        <td height="16" class="listtable_1">
                            <?php if (!empty($_smarty_tpl->tpl_vars['ban']->value['admin'])) {?>
                                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ban']->value['admin'], ENT_QUOTES, 'ISO-8859-1', true);?>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['ban']->value['communityid'];?>
                                    ...
                                    <tr align="left">
                                        ...
                                        <td height="16" class="listtable_1">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['ban']->value['removedby'])) {?>
                                                <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ban']->value['removedby'], ENT_QUOTES, 'ISO-8859-1', true);?>
                                ...
                                <tr align="left">
                                    ...
                                    <td height="16" class="listtable_1"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ban']->value['reason'], ENT_QUOTES, 'ISO-8859-1', true);?>
</td>
                                </tr>
                                <?php if (!$_smarty_tpl->tpl_vars['hideadminname']->value) {?>
                                    <tr align="left">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <?php if (!empty($_smarty_tpl->tpl_vars['commenta']->value['comname'])) {?>
                                                                    <b><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['commenta']->value['comname'], ENT_QUOTES, 'ISO-8859-1', true);?>
</b>
                                                                <?php } else { ?>
                                                                    <i><font color="#677882">Admin deleted</font></i>
                                                                <?php }?>
