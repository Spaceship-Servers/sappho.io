<?php /* Smarty version 2.6.31, created on 2021-12-07 22:22:28
         compiled from page_admin_edit_comms.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'help_icon', 'page_admin_edit_comms.tpl', 19, false),array('function', 'sb_button', 'page_admin_edit_comms.tpl', 135, false),)), $this); ?>
                ...
                <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
                    <tr>
                        <td valign="top" width="35%">
                            <div class="rowdesc">
                                <?php echo smarty_function_help_icon(array('title' => 'Player name','message' => "This is the name of the player that was blocked."), $this);?>
Player name
                            </div>
                        </td>
                        <td>
...
" type="text" TABINDEX=2 class="submit-fields" id="steam" name="steam" />
                            </div>
...
Block Reason
                    ...
                    <tr>
                        <td valign="top" width="35%"><div class="rowdesc"><?php echo smarty_function_help_icon(array('title' => 'Block Length','message' => "Select how long you want to block this person for."), $this);?>
Block Length</div></td>
                        <td><div align="left">
