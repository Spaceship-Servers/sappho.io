...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sb_button', 'box_admin_log_search.tpl', 51, false),)), $this); ?>
<div align="center">
...
"><?php echo $this->_tpl_vars['admin']['user']; ?>
                        ...
                        <tr>
                            <td colspan="4"><?php echo smarty_function_sb_button(array('text' => 'Search','onclick' => "search_log();",'class' => 'ok','id' => 'searchbtn','submit' => false), $this);?>
</td>
                        </tr>
                    </table>
                </div>
