...
/* Smarty version 4.3.1, created on 2023-04-01 08:11:18
  from '/var/www/sappho.io/bans/themes/creatorsDARK/page_admin_bans_submissions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6427e72694fb86_05613561',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0bcd51d5fc4e47217b0feacf3f6663e69407841b' => 
    array (
      0 => '/var/www/sappho.io/bans/themes/creatorsDARK/page_admin_bans_submissions.tpl',
      1 => 1678938701,
      2 => 'file',
    ),
  ),
...
function content_6427e72694fb86_05613561 (Smarty_Internal_Template $_smarty_tpl) {
if (!$_smarty_tpl->tpl_vars['permissions_submissions']->value) {?>
    Access Denied!
<?php } else { ?>
    <h3 style="margin-top:0px;">Ban Submissions (<span id="subcount"><?php echo $_smarty_tpl->tpl_vars['submission_count']->value;?>
</span>)</h3>
    Click a player's nickname to view information about their submission<br /><br />
    <div id="banlist-nav">
        <?php echo $_smarty_tpl->tpl_vars['submission_nav']->value;?>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['submission_list']->value, 'sub');
...
?>
            <tr id="sid_<?php echo $_smarty_tpl->tpl_vars['sub']->value['subid'];?>
" class="opener3 tbl_out" <?php if ($_smarty_tpl->tpl_vars['sub']->value['hostname'] == '') {?>onclick="xajax_ServerHostPlayers('<?php echo $_smarty_tpl->tpl_vars['sub']->value['server'];?>
', 'id', 'sub<?php echo $_smarty_tpl->tpl_vars['sub']->value['subid'];?>
');"<?php }?> onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'">
                <td class="listtable_1" height='16'><?php echo $_smarty_tpl->tpl_vars['sub']->value['name'];?>
</td>
                <td class="listtable_1" height='16'><?php if ($_smarty_tpl->tpl_vars['sub']->value['SteamId'] != '') {
                    ...
                    <div class="opener3" width="100%" align="center">
                        <table width="90%" cellspacing="0" cellpadding="0" class="listtable">
                            ...
                            <tr align="left">
                                ...
                                <td height="" class="listtable_1" id="sub<?php echo $_smarty_tpl->tpl_vars['sub']->value['subid'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <?php echo '<script'; ?>
>InitAccordion('tr.opener3', 'div.opener3', 'mainwrapper');<?php echo '</script'; ?>
>
<?php }
}
}
